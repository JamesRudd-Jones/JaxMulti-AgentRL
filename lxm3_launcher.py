...
_WANDB_GROUP = flags.DEFINE_string("wandb_group", "BASELINES", "wandb group")
...
def main(_):
    ...
    with xm_cluster.create_experiment(experiment_title=exp_name) as experiment:
        ...
        #     files={config_flags.get_config_filename(FLAGS["config"]): "lxm3_config.py"})
        ...
        experiment.add(
            xm.Job(
                ...
                env_vars={"WANDB_API_KEY": wandb_api_key,
                          "WANDB_PROJECT": "ProbInfMarl",  # _WANDB_PROJECT.value,
